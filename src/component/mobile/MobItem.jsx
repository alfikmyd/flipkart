                ...
                <div className="mobItemMain">
                    ...
                    <div className="mobSecond">
                        ...
                        <div style={{display:"flex"}}>
                            ...
                            <span style={{fontSize:"12px", color:"#717478"}}>{item.revShort}</span>
                            <img style={{width:"60px",height:"16px"}} src={item.assured} alt="assure" />
                        </div>

                        <div>
                            <span style={{color:"#008C00",fontWeight:"bold", fontSize:"17px"}}><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" className="bi bi-arrow-down" viewBox="0 0 16 16">
                                <path fillRule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1" />
                            </svg> {item.off}</span>
                            <span style={{fontSize:"17px", color:"#717478", fontWeight:"600", textDecoration:"line-through"}}>{item.oldPrice}</span>
                            <span style={{fontSize:"17px", color:"black"}}>{item.price}</span>
                        </div>

                        <div>
                            <img style={{width:"38px",height:"12px"}} src={item.wow} alt="wow" />
                            <span style={{fontSize:"17px", color:"#1642B9", fontWeight:"600"}}>{item.bankPrice}</span>
                            <span style={{fontSize:"12px", color:"#1642B9"}}>{item.withBank}</span>
                        </div>

                        <span style={{fontSize:"12px"}}>{item.exchange || item.nmbr}</span>
                        <span></span>
                    </div>
