...
// function Filt({  setCheckedItems, setFilterValue }) {
// // function Filt(){
//     const location = useLocation();
//     const {product, filterValue, checkedItems, initialData} = location.state || {};
//     const [localFilterValue, setLocalFilterValue] = useState(filterValue || {});
//     // const { product = [], filterValue: initialFilter = {}, checkedItems: initialChecked = {} } = location.state || {};
...
//     // useEffect(() => {
//     //     const savedFilters = localStorage.getItem("checkedItems");
//     //     if(savedFilters){
//     //         setCheckedItems(JSON.parse(savedFilters));
//     //     }
//     // }, []);
//     // useEffect(() => {
...
//     //     setFilterValue && setFilterValue(filtered);
//     //     navigate(-1);
//     // };
...
//         Object.keys(checkedItems).forEach(filterType => {
//             const selected = Object.keys(checkedItems[filterType] || {}).filter(key => checkedItems[filterType][key]);
//             if(selected.length > 0){
//                 filtered = filtered.filter(p => selected.includes(p[filterType]));
//             }
//         });
...
//     // const anyChecked = checkedItems && typeof checkedItems === "object"
//     //     ? Object.values(checkedItems).some(
//     //         (group) => group && Object.values(group).some((v) => v)
//     //     )
//     //     : false;
...
//     //     checkedItems[filterType]?.[label] || false;
//     // };
    ...
    return (
        <div id="smallFilt">
                ...
                <div id="rightFilter">
                    ...
                    {filterMap[selectedFilter]?.map(item => (
                        ...
                        <label key={item.label}>
                            <input
                                type="checkbox"
                                checked={isChecked(selectedFilter, item.label)}
                                onChange={e => handleCheck(selectedFilter, item.label, e.target.checked)}
                            />
                            {item.label}
                        </label>
                    ))}
            ...
            <div id="mobFooter">
                ...
                <div className="mobFiltApply">
                    <button onClick={applyFilters} disabled={!anyChecked}>
                        Apply
                    </button>
                </div>
            </div>
